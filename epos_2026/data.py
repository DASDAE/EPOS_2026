...
The data ships inside this package, under ``epos_2026/data``, so that
installing the repository -- ``pip install git+https://github.com/DASDAE/epos_2026``,
...
an installed package unpacks its data to ``epos_2026_data`` beside the
notebook the first time it is asked for one. A repository checkout is used
where it stands: there is nothing to unpack.

The figures the notebooks draw ship alongside, under ``epos_2026/images``,
...
UNPACK_DIR_NAME = "epos_2026_data"
