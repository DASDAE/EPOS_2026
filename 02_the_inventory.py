...
def _(mo):
    mo.md(r"""
    In practice, the inventory can conveniently be kept as a directory of CSV/YAML files. This deployment's Inventory is found in `epos_2026/data/inventory`.
    """)
    return
...
def _():
    ...
    from epos_2026 import get_data_path, get_image_path, get_inventory_path
